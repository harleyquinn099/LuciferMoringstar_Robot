    ...
    if usr_cmdall1.startswith("/start pr0fess0r_99"):
        if AUTH_CHANNEL:
            ...
            try:
                ...
                await bot.send_message(
                    chat_id=message.from_user.id,
                    text="ചാനലില്‍ നിങ്ങള്‍ ഉണ്ട് എങ്കിലേ ഈ ബോട്ട് വഴി നിങ്ങള്‍ക്ക് സിനിമ കിട്ടുകയുള്ളൂ അത് കൊണ്ട്‌ ചാനലില്‍ ജോയിൻ ആവുക 😊",
        ...
        try:
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('💠 CHANNEL 💠', url=f'{FORCES_SUB}')
                    ],
                    [
...
async def bot_info(bot, message):
    buttons = [
        [
            InlineKeyboardButton('Channel', url='https://t.me/unlimtedmovie00'),
            InlineKeyboardButton('Group', url='https://t.me/filmgallery0999')
        ]
        ]
